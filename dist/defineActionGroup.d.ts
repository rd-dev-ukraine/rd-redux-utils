...
export declare function defineActionGroup<TCommonProps>(_typePrefix: string): ActionGroup<TCommonProps>;
/**
...
export interface ActionGroup<TCommonProps, TExtraActions extends Action = never> {
     ...
     */
    includeAction<TAction extends Action>(test: (action: Action) => action is TAction, extractProps: (action: TAction) => TCommonProps): ActionGroup<TCommonProps, TExtraActions | TAction>;
}
